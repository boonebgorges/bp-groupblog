				...
				<div id='groupblog_landing_page'>
					...
					<table class="form-table">
						...
						<tr>
							...
							<td>
								<label><input class="info-off" name="bp_groupblog_redirect_blog" id="bp_groupblog_redirect_blog"  value="0" type="radio" 
								<?php
								if ( $opt['redirectblog'] == 0 ) {
									echo 'checked="checked"';}
								?>
								 > <?php _e( 'Disabled', 'groupblog' ); ?></label>
							</td>
						</tr>
						<tr>
							<th></th>
							<td>
								<label><input class="info-off" name="bp_groupblog_redirect_blog" id="bp_groupblog_redirect_blog"  value="1" type="radio" 
								<?php
								if ( $opt['redirectblog'] == 1 ) {
									echo 'checked="checked"';}
								?>
								 > <?php _e( 'Home Page', 'groupblog' ); ?></label>
							</td>
						<tr>
							<th></th>
							<td>
								<label><input class="info-on" name="bp_groupblog_redirect_blog" id="bp_groupblog_redirect_blog"  value="2" type="radio" 
								<?php
								if ( $opt['redirectblog'] == 2 ) {
									echo 'checked="checked"';}
								?>
								 > <?php _e( 'Page Template Title: ', 'groupblog' ); ?></label>
						...
						<tr>
							...
							<td>
								<label for="deep_group_integration"><input name="deep_group_integration" type="checkbox" id="deep_group_integration" value="1" 
								<?php
								if ( $opt['deep_group_integration'] == 1 ) {
									echo( 'checked="checked"' );}
								?>
								 /> <?php _e( 'Yes, redirect Group Home to Blog Home', 'groupblog' ); ?></label><p><?php _e( 'This option will take control of the GROUP home page and redirects it to the BLOG home page. This will enable posting from the group Home using P2 instead of the BuddyPress form.', 'groupblog' ); ?></p>
						  </td>
						</tr>
						</tbody>
					</table>
				...
				<?php if ( $opt['theme'] == 'p2|p2-buddypress' ) { ?>
					...
					<table class="enabled" id="availablethemes" cellspacing="0" cellpadding="0">
						...
						<tr class="alt">
							<td class="available-theme top left">
								...
								<div class="clear"></div>
								<input name="page_template_layout" id="page_template_layout"  value="magazine" type="radio" 
								<?php
								if ( $opt['page_template_layout'] == 'magazine' ) {
									echo 'checked="checked"';}
								?>
								  /><h3 style="display:inline;"> <?php _e( 'Magazine', 'groupblog' ); ?></h3>
							...
							<td class="available-theme top">
								...
								<div class="clear"></div>
								<input name="page_template_layout" id="page_template_layout"  value="microblog" type="radio" 
								<?php
								if ( $opt['page_template_layout'] == 'microblog' ) {
									echo 'checked="checked"';}
								?>
								 /><h3 style="display:inline;"> <?php _e( 'Microblog', 'groupblog' ); ?></h3>
					...
					<tbody>
						<tr>
							...
							<td>
								<label for="group_admin_layout"><input name="group_admin_layout" type="checkbox" id="group_admin_layout" value="1" 
								<?php
								if ( $opt['group_admin_layout'] == 1 ) {
									echo( 'checked="checked"' );}
								?>
								 /> <?php _e( 'Allow group admins to select the layout for their group themselves.', 'groupblog' ); ?></label>
						  </td>
						</tr>
						</tbody>
					</table>
					...
					<th><?php _e( 'Default Post Category:', 'groupblog' ); ?></th>
						...
						<tr>
							...
							<td>
							   ...
							   <input name="delete_first_post" type="checkbox" id="delete_first_post" value="1" 
							   <?php
								if ( $opt['delete_first_post'] == 1 ) {
									echo( 'checked="checked"' );}
								?>
								 /> <?php _e( 'Yes', 'groupblog' ); ?> <?php _e( '(Default Post "Hello World")', 'groupblog' ); ?>
						   </label>
							</td>
						</tr>
					<tr>
							...
							<input name="delete_first_comment" type="checkbox" id="delete_first_comment" value="1" 
							<?php
							if ( $opt['delete_first_comment'] == 1 ) {
								echo( 'checked="checked"' );}
							?>
							 /> <?php _e( 'Yes', 'groupblog' ); ?>
						   </label>
							</td>
						</tr>
						<tr>
							...
							<td>
								<label for="delete_blogroll_links">
									<input name="delete_blogroll_links" type="checkbox" id="delete_blogroll_links" value="1" 
									<?php
					...
					<table class="form-table">
						...
						<tr>
							...
							<td>
							   ...
							   <input name="bp_groupblog_allowdashes" type="checkbox" id="bp_groupblog_allowdashes" value="1" 
							   <?php
								if ( $opt['allowdashes'] == 1 ) {
									echo 'checked="checked"';}
								?>
								 /> <?php _e( 'Dashes', 'groupblog' ); ?> <?php _e( '(Default: Not Allowed)', 'groupblog' ); ?>
						   </label>
							</td>
						</tr>
					<tr>
						<th></th>
							...
							<input name="bp_groupblog_allowunderscores" type="checkbox" id="bp_groupblog_allowunderscores" value="1" 
							<?php
							if ( $opt['allowunderscores'] == 1 ) {
								echo 'checked="checked"';}
							?>
							 /> <?php _e( 'Underscores', 'groupblog' ); ?> <?php _e( '(Default: Not Allowed)', 'groupblog' ); ?>
						   </label>
							</td>
						</tr>
						<tr>
							...
							<td>
								<label for="bp_groupblog_allownumeric">
									<input name="bp_groupblog_allownumeric" type="checkbox" id="bp_groupblog_allownumeric" value="1" 
									<?php
									if ( $opt['allownumeric'] == 1 ) {
										echo 'checked="checked"';}
									?>
									 /> <?php _e( 'All Numeric Names', 'groupblog' ); ?> <?php _e( '(Default: Not Allowed)', 'groupblog' ); ?>
								</label>
							</td>
						</tr>
						<tr>
