...
NOTE: After plugin installation, you MUST copy the "groupblog" templates folder to your bp active member theme. See below.
...
`/wp-content/bp-themes/your-current-theme/groupblog`
